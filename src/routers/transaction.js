...
router.post("/getFinalForNotary", apiHandler(verifyUserToken), apiHandler(controller.getFinalForNotary));
router.post("/signed",apiHandler(verifyUserToken),apiHandler(controller.signedTransaction));
router.post("/NotarySigned",apiHandler(verifyUserToken),apiHandler(controller.notarySignedTransaction));
